  ...
  return (
    <footer className="bg-slate-900 text-slate-300 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mt-8 border-t border-slate-700 pt-6 pb-16 sm:pb-0 text-xs text-slate-500 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-3 sm:gap-0 text-center sm:text-left">
